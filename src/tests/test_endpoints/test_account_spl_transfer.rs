...
mod test_account_spl_transfer {
    ...
    async fn test_account_spl_transfer_success() {
        let json_data_file = fs::read_to_string("./src/tests/test_endpoints/sample_data/sample_account_spl_transfer.json").expect("Unable to read file");
        ...
        let result = solscan_api.get_account_spl_transfer("So11111111111111111111111111111111111111112", None, None, None, None).await.unwrap();
