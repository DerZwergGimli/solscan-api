...
mod test_token_holders {
    ...
    async fn test_token_holders_success() {
        let json_data_file = fs::read_to_string("./src/tests/test_endpoints/sample_data/sample_token_holders.json").expect("Unable to read file");
        ...
        let result = solscan_api.get_token_holders("So11111111111111111111111111111111111111112", None, None).await.unwrap();
