...
mod test_token_meta {
    ...
    async fn test_token_meta_success() {
        let json_data_file = fs::read_to_string("./src/tests/test_endpoints/sample_data/sample_token_meta.json").expect("Unable to read file");
        ...
        let result = solscan_api.get_token_meta("So11111111111111111111111111111111111111112").await.unwrap();
